...
@Component({
  selector: 'app-answer',
  templateUrl: './answer-word.component.html',
  styleUrls: ['./answer-word.component.css']
})

export class AnswerWordComponent implements OnInit, AfterViewInit {
  questions: any[] = [];
  answers: any = [];
  newAnswers: Answer[] = [];
  // myAnswers: Answer[] = [];
  ...
  onSubmit(post: any): void {
    ...
    this.router.navigateByUrl('showWordResult');
