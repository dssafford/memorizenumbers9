...
@Component({
  ...
  templateUrl: './answer-show-word.component.html',
  styleUrls: ['./answer-show-word.component.css']
})
export class AnswerShowWordComponent implements OnInit, AfterViewInit {
  message: string;
  ...
  onSubmit() {
    this.router.navigateByUrl('randomWords');
  }
